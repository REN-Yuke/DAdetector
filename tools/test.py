...
>>> python tools/test.py configs/pascal_voc/faster_rcnn_r50_fpn_1x_voc0712.py 
    ...
    --show-dir tools/faster_rcnn_r50_fpn_1x_voc0712/test_results 
...
>>> python tools/test.py configs/pascal_voc/faster_rcnn_convnext_tiny_fpn_1x_voc0712.py 
    checkpoints/none.py
    --cfg-options data.samples_per_gpu=16 
    --show-dir tools/faster_rcnn_convnext_tiny_fpn_1x_voc0712/test_results 
