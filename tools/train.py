...
>>> python tools/train.py configs/pascal_voc/faster_rcnn_r50_fpn_1x_voc0712.py 
    --cfg-options data.samples_per_gpu=2 data.train.times=1 runner.max_epochs=1 
    --auto-scale-lr 
    --work-dir my_results/faster_rcnn_r50_fpn_1x_voc0712/train_results 

>>> python tools/train.py configs/pascal_voc/faster_rcnn_convnext_tiny_fpn_1x_voc0712.py 
    --cfg-options data.samples_per_gpu=1 data.train.times=1 runner.max_epochs=1 
    --auto-scale-lr 
    --work-dir my_results/faster_rcnn_convnext_tiny_fpn_1x_voc0712/train_results 

# FasterRCNN + nuImages
>>> python tools/train.py configs/nuimages/faster_rcnn_r50_fpn_1x_nuim.py 
    --cfg-options data.samples_per_gpu=1 runner.max_epochs=5 
    --auto-scale-lr 
    --work-dir my_results/faster_rcnn_r50_fpn_1x_nuim/train_results 

>>> python tools/train.py configs/nuimages/faster_rcnn_convnext_tiny_fpn_1x_nuim.py 
    --cfg-options data.samples_per_gpu=1 runner.max_epochs=1 
    --auto-scale-lr 
    --work-dir my_results/faster_rcnn_convnext_tiny_fpn_1x_nuim/train_results 
